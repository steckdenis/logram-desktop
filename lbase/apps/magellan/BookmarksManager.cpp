...
BookmarksManager::BookmarksManager(QString fileName, QMenu *parentMenu, bool forWebBrowsing = false)
{
...
QIcon BookmarksManager::favicon(QUrl adress)
{
...
void BookmarksManager::updateBookmarks()
{
    Signet *sign;
...
void BookmarksManager::bookmarkIsClicked(bool)
{
...
void BookmarksManager::addBookmark(QString title, QUrl adress)
{
