...
void Client::addControls()
{
        ...
        //Boutons
        btnclose   = new LImageButton(QPixmap(path + "window-close.png"), QPixmap(path + "window-close-hovered.png"), QPixmap(path + "window-close-hovered.png"), this);
        btnmaximum = new LImageButton(QPixmap(path + "window-maximize.png"), QPixmap(path + "window-maximize-hovered.png"), QPixmap(path + "window-maximize-hovered.png"), this);
        btnminimum = new LImageButton(QPixmap(path + "window-minimize.png"), QPixmap(path + "window-minimize-hovered.png"), QPixmap(path + "window-minimize-hovered.png"), this);
